		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Extension project 1",
									"targetURL": "#opensapextensionproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"opensapextensionproject1-display": {
								"semanticObject": "opensapextensionproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=opensap.extensionproject1",
									"url": sap.ui.require.toUrl("opensap/extensionproject1")
								}
							}
						}
					}
