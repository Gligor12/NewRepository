		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employee App",
									"targetURL": "#opensaptest1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"opensaptest1-display": {
								"semanticObject": "opensaptest1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=opensap.test1",
									"url": sap.ui.require.toUrl("opensap/test1")
								}
							}
						}
					}
